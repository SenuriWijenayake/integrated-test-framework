function emotion(){
    ...
    var instructions_block = {
        ...
        choices: ['Continue'],
        data: {trial_category: 'instructions', unique_trial_id: 5100}
    };
    ...
    var trials = {
        timeline: [

            {
                ...
                data: {trial_category:'emotion',unique_trial_id:5101},
...

            {
                ...
                data: {trial_category:'emotion',unique_trial_id:5102},
                on_finish: function (data) {
                    data.response = JSON.parse(data.responses);
                    data.response = data.response['Q0'] + 1;
                }
...

            {
                ...
                data: {trial_category:'emotion',unique_trial_id:5103},
                on_finish: function (data) {
                    data.response = JSON.parse(data.responses);
                    data.response = data.response['Q0'] + 1;
                }
