    ...
    var test_stimuli = [
        {
            ...
            data: {stim_type: 'congruent', direction: 'left', trial_category: 'flanker', unique_trial_id: 201}
        },
        {
            stimulus: "/static/images/flanker/con2.png",
            data: {stim_type: 'congruent', direction: 'right', trial_category: 'flanker', unique_trial_id: 202}
        },
        {
            stimulus: "/static/images/flanker/inc1.png",
            data: {stim_type: 'incongruent', direction: 'right', trial_category: 'flanker', unique_trial_id: 203}
        },
        {
            stimulus: "/static/images/flanker/inc2.png",
            data: {stim_type: 'incongruent', direction: 'left', trial_category: 'flanker', unique_trial_id: 204}
        }
    ];
